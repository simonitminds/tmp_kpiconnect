defmodule Oceanconnect.Admin.FuelIndex.EditPage do
  use Oceanconnect.Page

  def visit(id) do
    navigate_to("/admin/fuel_index_entries/#{id}/edit")
  end

  def has_fields?(fields) do
    Enum.all?(fields, fn field ->
      find_element(:css, ".qa-admin-fuel_index-#{field}")
    end)
  end

  def is_current_path?(id) do
    current_path() == "/admin/fuel_index_entries/#{id}/edit"
  end
  ...
  def fill_form(params = %{}) do
    ...
    |> Enum.map(fn {key, value} ->
      element = find_element(:css, ".qa-admin-fuel_index-#{key}")
