defmodule Oceanconnect.Auctions.AuctionEmailNotifierTest do
  ...
  setup do
    ...
    auction =
      insert(:auction, buyer: buyer_company, suppliers: supplier_companies, auction_vessel_fuels: [build(:vessel_fuel, vessel: vessel, fuel: fuel, quantity: 200)], scheduled_start: DateTime.utc_now())
