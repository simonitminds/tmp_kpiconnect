defmodule OceanconnectWeb.Endpoint do
  ...
  plug Plug.Static,
    at: "/", from: :oceanconnect, gzip: false,
    only: ~w(css fonts images js favicon.ico robots.txt time_sync.txt)
  ...
  plug Plug.Session,
    store: :cookie,
    key: "_oceanconnect_key",
    signing_salt: "SASfBvjJ"

  plug OceanconnectWeb.Router
