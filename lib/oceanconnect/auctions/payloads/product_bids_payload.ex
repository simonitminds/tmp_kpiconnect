defmodule Oceanconnect.Auctions.Payloads.ProductBidsPayload do
  ...
  def get_product_bids_payload!(state = %ProductBidState{lowest_bids: lowest_bids, bids: bids}, auction: auction, buyer: buyer_id) do
    %{
  ...
  def get_product_bids_payload!(state = %ProductBidState{lowest_bids: lowest_bids, bids: bids}, auction: auction, supplier: supplier_id) do
    %{
  ...
  defp is_leading?(_state = %ProductBidState{lowest_bids: lowest_bids = [lowest | _]}, supplier_id) do
    lowest_bids
    |> Enum.any?(fn(bid) ->
