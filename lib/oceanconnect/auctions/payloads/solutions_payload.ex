defmodule Oceanconnect.Auctions.Payloads.SolutionsPayload do
  ...
  defp list_other_solutions(solutions = %{best_overall: best_overall, best_by_supplier: best_by_supplier, best_single_supplier: best_single_supplier}, nil) do
  ...
  defp list_other_solutions(solutions = %{best_overall: best_overall, best_by_supplier: best_by_supplier, best_single_supplier: best_single_supplier}, %Solution{bids: winning_bids}) do
