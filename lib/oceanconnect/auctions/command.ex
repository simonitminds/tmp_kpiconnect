defmodule Oceanconnect.Auctions.Command do
  ...
  def select_winning_solution(solution = %Solution{bids: _bids}, auction, user) do
    %Command{command: :select_winning_solution, data: %{solution: solution, auction: auction, user: user}}
  end
