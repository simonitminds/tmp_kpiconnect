defmodule Oceanconnect.Notifications.Emails.FixtureDelivered do
  ...
  defp emails(recipients, %{auction_id: auction_id, vessel: vessel, delivered_vessel: delivered_vessel} = fixture) do
    vessel =
      cond do
    ...
    |> Enum.map(fn recipient ->
      ...
      |> subject("A fixture has been marked as delivered for Auction #{auction_id} on #{vessel.name}")
  ...
  defp recipients(%{supplier_id: supplier_id, delivered_supplier_id: delivered_supplier_id}) when supplier_id != delivered_supplier_id do
