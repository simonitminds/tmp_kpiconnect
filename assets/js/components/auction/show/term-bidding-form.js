...
import TermBiddingFormProduct from './term-bidding-form-product';

class TermBiddingForm extends React.Component {
  constructor(props){
    super(props);
  ...
  render() {
    ...
    return (
      <div className={`auction-bidding ${auctionStatus == 'pending'? `auction-bidding--pending` : ``} box bnox--nested-base`}>
...
export default TermBiddingForm;
