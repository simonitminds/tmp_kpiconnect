...
const AuctionShow = (props) => {
  const auction = _.chain(props.auctions)
    .filter(['id', window.auctionId])
    .first()
    .value();

  const additionalInfoDisplay = (a) => {
    if (a.additional_information) {
      return a.additional_information;
    }
    else { return <i>No additional information provided.</i>; }
  }
                ...
                <div className="box">
                  ...
                  <div className="box__subsection box__subsection--bordered box__subsection--base">
                    ...
                    <div className="field is-horizontal is-expanded">  Fuel Type
                      <div className="field-label">
                        <div className="control">
                          <label className="label" for="">Fuel Type</label>
                        </div>
                      </div>
                    ...
                    <div className="field is-horizontal is-expanded"> Bid Amount
                      <div className="field-label">
                        <div className="control">
                          <label className="label" for="bid">Bid Amount</label>
                        </div>
                      </div>
                      <div className="field-body">
                    ...
                    <div className="field is-horizontal is-expanded">  Bid Expiration
                      <div className="field-label">
                        <div className="control">
                          <label className="label" for="">Expiration</label>
                        </div>
                      </div>
                      <div className="field-body">
                        <div className="control is-expanded">
                    ...
                    <div className="field is-horizontal is-expanded">  Credit Terms
                      <div className="field-label">
                        <div className="control">
                          <label className="label" for="">Credit Terms</label>
                        </div>
                      </div>
                      <div className="field-body">
                        <div className="control is-expanded">
