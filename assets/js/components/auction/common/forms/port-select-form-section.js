            ...
            { hasDurationAndTerminal &&
              <div>
                ...
                <div className="field is-horizontal">
                  ...
                  <div className="field-body">
                    <input type="hidden" name="auction[start_date]" value={auction.start_date ? moment(auction.start_date).utc() : ""} />
                    <DateMonthInput
                      value={""}
                      model={'auction'}
                      field={'start_date'}
                ...
                <div className="field is-horizontal">
                  ...
                  <div className="field-body">
                    <input type="hidden" name="auction[end_date]" value={auction.end_date ? moment(auction.end_date).utc() : ""} />
                    <DateMonthInput
                      value={""}
                      model={'auction'}
                      field={'end_date'}
