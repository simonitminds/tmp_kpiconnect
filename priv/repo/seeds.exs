...
companies = [
  %{name: "Chevron Tankers", address1: "",
    address2: "", city: "", is_supplier: false,
    country: "", contact_name: "", email: "chevron@example.com",
    main_phone: "", mobile_phone: "", postal_code: 22666},
  %{name: "Nigeria LNG", address1: "",
    address2: "", city: "", is_supplier: false,
    country: "", contact_name: "", email: "nigeria@example.com",
    main_phone: "", mobile_phone: "", postal_code: 22666},
  %{name: "Qatargas Operating Company Limited", address1: "Office 2W-705",
    address2: "", city: "Doha", is_supplier: true,
